...
import { Button, Link, Popover, PopoverContent, PopoverTrigger, Progress } from "@nextui-org/react"
        ...
        ? <footer className="fixed bottom-1 flex items-start ml-2 mb-4 w-fit">
          ...
          <div className="flex flex-col">
            ...
            <Link href={ site.page._.home }
                  ...
                  className={ clsx("w-full justify-center cursor-pointer text-secondary-400 tracking-widest hover:text-fuchsia-400", fontPrimary.className) }>
              hi@saasy.ui
            </Link>
