      ...
      <form className={ clsx("flex flex-col gap-5 w-full m-auto", error.show && "animate-shake animate-once") }
          ...
          <div className="col-span-2 space-y-5">
            { page == 1 &&
              <Card
                ...
                <CardHeader className="h-fit w-full">
                  <h4 className={ `text-2xl text-primary text-end tracking-widest m-2 ${ fontPrimary.className }` }>Unsubscribed</h4>
                </CardHeader>
            ...
            { page == 2 &&
              <Card
                className="w-full h-72 flex flex-col shadow-xl shadow-primary justify-between bg-transparent animate-flip-down animate-duration-1000">
                <CardHeader className="h-fit w-full">
                  <h4 className={ `text-2xl text-primary text-end tracking-widest m-2 ${ fontPrimary.className }` }>Startup</h4>
                </CardHeader>
                <CardFooter className="h-fit w-full justify-end">
                  { edit && pagination }
                </CardFooter>
            ...
            { page == 3 &&
              <Card
                className="w-full h-72 flex flex-col shadow-xl shadow-primary justify-between bg-transparent animate-flip-down animate-duration-1000">
                <CardHeader className="h-fit w-full">
                  <h4 className={ `text-2xl text-primary text-end tracking-widest m-2 ${ fontPrimary.className }` }>Enterprise</h4>
                </CardHeader>
                <CardFooter className="h-fit w-full justify-end">
                  { edit && pagination }
                </CardFooter>
        ...
        <div className={ clsx("flex justify-end gap-5 pt-12", !edit && "hidden") }>
          <Button aria-label="Cancel"
                  variant="bordered"
                  color="danger"
                  onClick={ () => router.push(site.page.user.settings.view) }>
            Cancel
          </Button>
          <Button type="submit"
                  aria-label="Save"
