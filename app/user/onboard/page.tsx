...
import { Button, Checkbox, Input, ModalBody, ModalContent, ModalHeader, Tooltip, useDisclosure } from "@nextui-org/react"
...
export default function CreateAccount(): React.JSX.Element {
  ...
  const { control, handleSubmit, formState: { isSubmitting, isSubmitSuccessful, errors } } = useForm<FormInput>({
    defaultValues: {
      username: "",
      email: "",
      phone: "",
        ...
        <div className="flex justify-center gap-10 mt-5">
          <Tooltip showArrow={ true }
            ...
            <Button isIconOnly
                    ...
                    onClick={ () => router.push(site.page.auth.onboard.resendCode) }
          ...
          <Tooltip showArrow={ true }
            ...
            <Button isIconOnly
                    aria-label="Login"
                    onClick={ () => router.push(site.page.auth.login._) }
                    className="bg-transparent">
              <svg xmlns="http://www.w3.org/2000/svg"
                   viewBox="0 0 24 24"
                   className="w-8 h-8 fill-secondary hover:animate-pulse hover:animate-once">
